...
<head>
  ...
  <title>Dashboard -Tech2Electronics  Bootstrap Template</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Tech2Electronics</span>
      </a>
...
@yield('content')
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Tech2Electronics</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
